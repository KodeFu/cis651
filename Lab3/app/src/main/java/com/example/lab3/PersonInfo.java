...
public class PersonInfo implements Parcelable {
    ...
    {
        parcel.writeStringArray(new String[] { name, lastname, city, zip, language });
    }

    public static final Parcelable.Creator<PersonInfo>CREATOR = new Parcelable.Creator<PersonInfo>() {

        @Override public PersonInfo createFromParcel(Parcel parcel) {
            return new PersonInfo(parcel);
        }

        @Override public PersonInfo[] newArray(int i) {
